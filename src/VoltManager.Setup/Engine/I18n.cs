...
namespace VoltManager.Setup.Engine
{
    public static class I18n
    {
        private static readonly Dictionary<string, string> It = new()
        {
            ...
            ["options_channel"]       = "Versione",
            ["options_channel_stable"] = "Stabile (consigliata)",
            ["options_channel_stable_d"] = "Installa subito l'ultima versione stabile inclusa in questo setup.",
            ["options_channel_preview"] = "Preview (Beta)",
            ["options_channel_preview_d"] = "Scarica e installa subito l'ultima build Preview da GitHub. Può contenere funzioni sperimentali.",
            ["status_download_preview"] = "Download versione Preview (Beta) da GitHub…",
            ["err_preview_norelease"]  = "Nessuna versione Preview disponibile su GitHub.",
            ["err_preview_noasset"]    = "La release Preview non contiene il file di installazione.",
            ["err_preview_download"]   = "Download della versione Preview non riuscito:",
            ["err_preview_payload"]    = "Impossibile leggere i file della versione Preview scaricata.",
            ...
            ["update_failed"]       = "Aggiornamento di VoltManager non riuscito.\n\n{0}\n\nScarica il setup dalla pagina delle release e avvialo manualmente. Dettagli nel file:\n{1}",
        ...
        private static readonly Dictionary<string, string> En = new Dictionary<string, string>
        {
            ...
            ["options_channel"]       = "Version",
            ["options_channel_stable"] = "Stable (recommended)",
            ["options_channel_stable_d"] = "Installs the latest stable build bundled with this setup right away.",
            ["options_channel_preview"] = "Preview (Beta)",
            ["options_channel_preview_d"] = "Downloads and installs the latest Preview build from GitHub immediately. It may include experimental features.",
            ["status_download_preview"] = "Downloading Preview (Beta) build from GitHub…",
            ["err_preview_norelease"]  = "No Preview release available on GitHub.",
            ["err_preview_noasset"]    = "The Preview release does not contain an installer file.",
            ["err_preview_download"]   = "Preview download failed:",
            ["err_preview_payload"]    = "Unable to read the downloaded Preview build files.",
            ...
            ["update_failed"]       = "VoltManager update failed.\n\n{0}\n\nDownload the setup from the releases page and run it manually. Details in:\n{1}",
        ...
        private static readonly Dictionary<string, string> Zh = new Dictionary<string, string>
        {
            ...
            ["options_channel"]       = "版本",
            ["options_channel_stable"] = "稳定版（推荐）",
            ["options_channel_stable_d"] = "立即安装此安装程序内置的最新稳定版本。",
            ["options_channel_preview"] = "预览版（Beta）",
            ["options_channel_preview_d"] = "立即从 GitHub 下载并安装最新的预览版本，可能包含实验性功能。",
            ["status_download_preview"] = "正在从 GitHub 下载预览版（Beta）…",
            ["err_preview_norelease"]  = "GitHub 上没有可用的预览版本。",
            ["err_preview_noasset"]    = "预览版本不包含安装文件。",
            ["err_preview_download"]   = "预览版本下载失败：",
            ["err_preview_payload"]    = "无法读取已下载的预览版本文件。",
            ["progress_title"]      = "正在安装…",
            ["progress_wait"]       = "请稍候，不要关闭此窗口。",
            ["done_title"]          = "安装完成",
            ["done_title_err"]      = "安装失败",
            ["update_failed"]       = "VoltManager 更新失败。\n\n{0}\n\n请从发布页面下载安装程序并手动运行。详细信息：\n{1}",
        ...
        private static readonly Dictionary<string, string> Es = new()
        {
            ...
            ["options_channel"]       = "Versión",
            ["options_channel_stable"] = "Estable (recomendada)",
            ["options_channel_stable_d"] = "Instala de inmediato la última versión estable incluida en este instalador.",
            ["options_channel_preview"] = "Vista previa (Beta)",
            ["options_channel_preview_d"] = "Descarga e instala al instante la última versión Preview desde GitHub. Puede incluir funciones experimentales.",
            ["status_download_preview"] = "Descargando la versión Preview (Beta) desde GitHub…",
            ["err_preview_norelease"]  = "No hay ninguna versión Preview disponible en GitHub.",
            ["err_preview_noasset"]    = "La versión Preview no contiene el archivo de instalación.",
            ["err_preview_download"]   = "Error al descargar la versión Preview:",
            ["err_preview_payload"]    = "No se pudieron leer los archivos de la versión Preview descargada.",
            ...
            ["update_failed"]       = "No se pudo actualizar VoltManager.\n\n{0}\n\nDescarga el instalador desde la página de versiones y ejecútalo manualmente. Detalles en:\n{1}",
