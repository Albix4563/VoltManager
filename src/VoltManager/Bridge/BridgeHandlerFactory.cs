        ...
        Action closeWidget)
    {
        ...
        var energyHandler = new EnergyRpcHandler(
            ...
            new EnergyRpcActions(
                ...
                power.FindExtraPlans,
                power.DeleteExtraPlans,
                power.DismissExtraPlans,
                power.GetActivePlan,
                ...
                app.PowerRequests.SetThermalGuardEnabled,
                app.ThermalGuard.ApplySettings,
                () => app.IdlePowerGuard.Current,
                app.PowerRequests.SetIdlePowerGuardEnabled,
        ...
        var updateHandler = new UpdateRpcHandler(
            ...
            new UpdateRpcActions(
                ...
                updates.IsKnownReleaseAssetUrl,
        ...
        var applicationHandler = new ApplicationRpcHandler(
            ...
            new ApplicationRpcActions(
                ...
                Logger.Error,
                WebViewNavigationPolicy.OpenExternal,
                requestExit,
                requestMinimize,
                app.ShowMainWindow));
