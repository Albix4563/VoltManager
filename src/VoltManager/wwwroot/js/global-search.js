...
(function () {
    ...
    const catalog = [
        ...
        { id: 'power-keep-awake', labelKey: 'tab_keep_awake', descriptionKey: 'search_desc_keep_awake', keywords: ['search_kw_awake', 'search_kw_sleep'], icon: 'bedtime_off', category: 'power', view: 'power-plans', subview: 'keep-awake', targetId: 'keep-awake-mount' },
